                    ...
                    <div class="dt-header__container">
                        ...
                        <div class="dt-header__toolbar">
                            ...
                            <?php if($displayBreadcrumbs == true) {?>
                                <h1 class="dt-page__title mt-4" style="margin-left: -1.5em;"><?php echo $breadcrumbs ?></h1>
                            <?php } else {?>
                                <form method="post">
                                <?php $csrf = array(
                            ...
                            <ul class="dt-side-nav">
                                ...
                                <li
                                    ...
                                    <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                        title="Dashboard">
                                        <i class="fa fa-dollar-sign fa-lg"></i> <span
                                ...
                                <li
                                    ...
                                    <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                        title="Dashboard">
                                        <i class="fa fa-wallet fa-lg"></i><span
                                    ...
                                    <ul class="dt-side-nav__sub-menu <?php echo $this->uri->segment(1)=="clients" || $this->uri->segment(1)=="team" ? "display-b" : "display-n"?>">
                                        ...
                                        <li
                                            ...
                                            <a href="<?php echo base_url(); ?>clients"
                                                ...
                                                title="Traffic">
                                                <span class="dt-side-nav__text"><?php echo "All Users" ?></span> </a>
                                        </li>
                                        <?php }?>
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="<?php echo base_url(); ?>team"
                                                ...
                                                title="Revenue">
                                                <span class="dt-side-nav__text"><?php echo "Managers" ?></span> </a>
                                        </li>
                                        <?php }?>
                                    </ul>
                                    <!-- /sub-menu -->
                                ...
                                $role == ROLE_ADMIN) {?>
                                <li class="dt-side-nav__item <?php if($this->uri->segment(1)=="withdrawals" || $this->uri->segment(1)=="deposits" || $this->uri->segment(1)=="earnings"){echo "selected open";}?>">
                                    <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                        title="Dashboard">
                                        <i class="fa fa-dollar-sign fa-lg"></i><span
                                ...
                                <li
                                    ...
                                    <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                        title="Dashboard">
                                        <i class="fa fa-toolbox fa-lg"></i><span
