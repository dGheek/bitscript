        ...
        <div class="profile">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    <a href="<?php echo base_url(); ?>clients/newClient" class="btn btn-light btn-sm display-i ft-right"><?php echo "Add User" ?></a>
                    <?php }?>
                    <?php } else if ($pageTitle == "Team") { ?>
                    <!-- Check the access for this component -->
                    <?php if($this->user_model->getPermissions('teams', 'add', $userId) OR $role == ROLE_ADMIN) {?>
                    <a href="<?php echo base_url(); ?>team/newManager" class="btn btn-light btn-sm display-i ft-right"><?php echo "Add Manager" ?></a>
                    <?php }?>
                    <?php } ?>
                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                    ...
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                        ...
                                        <div class="media">
                                            ...
                                            <i class="fa fa-users fa-3x mr-6 align-self-center"></i>
